...
export class AssetMapper {
     ...
     */
    generateLiquidReference(filename, assetType) {
        // 去掉 query string
     ...
     * 检查目标店铺是否有同名资源
     */
    async checkAssetExists(filename, themeAssets) {
        // 去掉 query string
        const cleanFilename = filename.split('?')[0];
     ...
     * 构建资源映射表
     */
    async buildAssetMappings(html, themeAssets) {
