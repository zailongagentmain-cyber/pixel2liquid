...
export class ProductMatcher {
    shopifyClient;
    cacheDir;
    constructor(shopifyClient, cacheDir = '.') {
     ...
     * 优先从本地缓存读取
     */
    async fetchTargetProducts(forceRefresh = false) {
     ...
     * 本地匹配源站产品和目标店铺产品
     */
    match(sourceHandles, targetProducts) {
        const matches = [];
...
//# sourceMappingURL=ProductMatcher.js.map